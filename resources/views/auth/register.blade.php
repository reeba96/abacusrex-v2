 ...
 <div class="main">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown language-menu">
              ...
              <ul class="dropdown-menu" name="language" id="language-selector" style="padding: 15px;">
                  ...
                  <li><div id="english-language"><a href="/en/register">English</a></div></li>
                  <li><div id="hungarian-language"><a href="/hu/register">Magyar</a></div></li>
              </ul>
            </li>
          </ul>
    </div>
    ...
    <div class="col-md-8 col-sm-12">
       <div class="login-form">
            ...
            <h2><b>{{trans('translate.user_creation')}}</b></h2>

            <p>{{trans('translate.user_creation_help')}}</p>

            <form method="POST" action="{{ route('emailCheck') }}">

            @csrf
             <div class="form-group">
                <label>{{trans('translate.email')}}</label>
                <input type="text" name="email" id="email" class="form-control login-input  @error('email') is-invalid @enderror" placeholder="Email" value="{{ old('email') }}" required>
             ...
             <button type="submit" class="btn btn-theme col-lg-12 col-xs-12">{{trans('translate.register')}}</button>
        ...
        $("#email").keyup(delay(function (e) {
			...
			$.ajax({
				...
				if(data.status == 'OK') {
                    ...
                    $("#email_error").show().html( data.message);
