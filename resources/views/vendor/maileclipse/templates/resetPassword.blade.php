...
<tbody>
<tr>
<td style="padding-bottom: 15px; background-color: #ffffff;" valign="top">
<h1>Alteo</h1>
</td>
</tr>
<tr>
<td style="padding-bottom: 20px; background-color: #ffffff;" valign="top"><strong></strong><br /></td>
</tr>
<tr>
<td>
<table width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
...
<a style="
  ...
  width: 200px; 
  -webkit-text-size-adjust: none;" 
  href="{{ URL::to($locale.'/reset/password/' . $id . '/' . $confirmation_code) }}"> {{trans('translate.reset_password_submit') }}  
</a>
...
<tr>
<td style="padding-top: 20px; background-color: #ffffff;"><br /></td>
</tr>
</tbody>
</table>
</td>
...
<tr>
<td class="footer-cell" valign="top">Alteo team<br /></td>
</tr>
</tbody>
</table>
</td>
