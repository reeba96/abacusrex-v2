    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <div class="float-left">
                <h4>{{ !empty($title) ? $title : trans("translate.countries") }}</h4>
            </div>
        ...
        <div class="card-header">
            ...
            <form method="POST" action="{{ route('countries.country.update', $countries->id) }}" id="edit_countries_form" name="edit_countries_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
