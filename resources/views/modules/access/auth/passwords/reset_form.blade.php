 ...
 <div class="main">
    ...
    <div class="col-md-8 col-sm-12">
       <div class="login-form">
            ...
            <h2><b>{{trans('translate.reset_password')}}</b></h2><br>
            ...
            <form method="POST" action="{{ route('new.password') }}">
                ...
                <div class="form-group">
                    <label>{{trans('translate.new_pass')}}</label>
                    <input id="password" type="password" class="form-control login-input  @error('email') is-invalid @enderror" name="password" placeholder='{{trans('translate.new_pass')}}' required autocomplete="new-password" autofocus><br>
                    <p id="email_error" style="display:hidden" class="help-block"></p>
                    <label>{{trans('translate.confirm_new_pass')}}</label>
                    <input id="password_confirmation" type="password" class="form-control login-input  @error('email') is-invalid @enderror" placeholder='{{trans('translate.confirm_new_pass')}}' name="password_confirmation" required autocomplete="new-password" autofocus>
                    @error('email')
             ...
             <button type="submit" class="btn btn-theme col-lg-12 col-xs-12">{{trans('translate.reset_password_submit')}}</button>
