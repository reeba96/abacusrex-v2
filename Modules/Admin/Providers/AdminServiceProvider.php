...
class AdminServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        $this->publishes([
            ...
            module_path($this->moduleName, 'Config/theme.php') => config_path($this->moduleNameLower . '.php'),
            module_path($this->moduleName, 'Config/slider_rev.php') => config_path($this->moduleNameLower . '.php'),
        ...
        $this->mergeConfigFrom(
            module_path($this->moduleName, 'Config/theme.php'), 'theme'
        );
        $this->mergeConfigFrom(
            module_path($this->moduleName, 'Config/slider_rev.php'), 'slider_rev'
        );
    }
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
           ...
           /*  ha kell, ez alapjan kell publishelni
            $this->publishes([
