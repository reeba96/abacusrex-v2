...
class MailablesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin::admin.mailables.sections.mailables', compact('mailables'));
    }

    public function generateMailable(Request $request)
    {
        MailEclipse::generateMailable($request);
        return redirect()->route('mailableList');
    }
    ...
    public function viewMailable($name)
    {
        ...
        return view('admin::admin.mailables.sections.view-mailable')->with(compact('resource'));
    }
    ...
    public function editMailable($name)
    {
        ...
        return view('admin::admin.mailables.sections.edit-mailable-template', compact('templateData', 'name'));
    }
